    ...
    <section id="home" className="py-10 md:py-40">
      ...
      >
        <div className="text-center">
          <h6 className="mt-16 mb-8 text-lg font-medium text-text1 md:text-2xl">
            Gregory Harris
          </h6>

          <h1 className="mb-8 text-4xl font-normal leading-none text-surface1 md:text-7xl">
            Front-end Developer
          </h1>

          <p className="mb-16 font-normal text-text1 text-md md:text-xl">
